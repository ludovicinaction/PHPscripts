...
/**
 * Class SPDO
 * Singleton de connexion à la base pour le compte administrateur.
  * @package COMMON
  * Source : http://www.apprendre-php.com/tutoriels/tutoriel-47-classe-singleton-d-accs-aux-sgbd-intgrant-pdo.html
  * voir aussi : https://github.com/DaRkD0G/Singleton_PDO_PHP/blob/master/SPDO.php
  **/
...
class SPDO
{
   ...
   * @var string
   */
  const DEFAULT_SQL_USER = 'connect_admin';
   ...
   * @var string
   */
  const DEFAULT_SQL_PASS = 'passwordadmin987456321';
